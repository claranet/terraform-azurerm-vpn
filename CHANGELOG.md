...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) f1444bb

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 1984fdc
* **deps:** update dependency tflint to v0.64.0 0cc10b5
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 29a43f3
* **v9:** 🐛 synchronize common files and docs 96164bd

## 8.4.6 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug b13e679

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 3dc04e5
* **deps:** update dependency opentofu to v1.12.2 2e3391d
* **deps:** update dependency opentofu to v1.12.3 e5dc5d3
* **deps:** update dependency opentofu to v1.12.4 ab5c9f8
* **deps:** update dependency tflint to v0.63.1 e2767b5
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 2f0ea75
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 53474f4

## 8.4.5 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ e4bf0a8

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu b4a2bdf
* **deps:** update dependency terraform-docs to v0.23.0 15a42c0
* **deps:** update dependency terraform-docs to v0.24.0 2b10a28
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 25d4159
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 b92c555
* **deps:** update tools 5af3b21
* **pre-commit:** 🔧 move to prek 386f766
* **tfdocs:** bump tfdocs to v0.22 🔧 5ea1e1c

## 8.4.4 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 5a3c5ff

### Code Refactoring

* update module structure and Github actions 👷 906648b

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing d6e081c
* **deps:** 🔗 bump tflint rules version 1a8c774
* **deps:** update dependency trivy to v0.69.2 6bf0f2e
* **deps:** update dependency trivy to v0.69.3 c95c1dc
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 6621509

## 8.4.3 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 c924eca

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.11.2 3169209
* **deps:** update dependency opentofu to v1.11.3 1dbb7fd
* **deps:** update dependency opentofu to v1.11.4 bc2bf35
* **deps:** update dependency opentofu to v1.11.5 db51e2e
* **deps:** update dependency tflint to v0.61.0 e337620
* **deps:** update dependency trivy to v0.69.0 70f7851
* **deps:** update dependency trivy to v0.69.1 268340e
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 8ade2fd
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 4203f3e
...
* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 440e771

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.6 59ff859
* **deps:** update dependency tflint to v0.59.1 4ddff9d
* **deps:** update dependency trivy to v0.66.0 547dd56
* **deps:** update dependency trivy to v0.67.0 f867410
* **deps:** update terraform claranet/diagnostic-settings/azurerm to ~> 8.2.0 e03665b
